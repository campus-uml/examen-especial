    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 lg:p-12">
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border rounded-lg shadow-sm">
          <img src="./public/img1.jpg" alt="Ledadu Beach" className="w-24 h-24 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-md" />
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border rounded-lg shadow-sm">
          <img src="./public/img2.jpg" alt="Endigada Beach" className="w-24 h-24 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-md" />
          <div className="flex flex-col flex-grow text-center sm:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border rounded-lg shadow-sm">
          <img src="./public/img3.jpg" alt="Doreen Tower" className="w-24 h-24 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-md" />
          <div className="flex flex-col flex-grow text-center sm:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border rounded-lg shadow-sm">
          <img src="./public/img4.jpg" alt="Royal Palace" className="w-24 h-24 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-md" />
          <div className="flex flex-col flex-grow text-center sm:text-left">
